...
module.exports = class extends think.Controller {
  ...
  async getAction() {
    ...
    if (this.id) {
      ...
      console.log(data,'检查请求输入')
      return this.success(data);
    }
    data = await this.modelInstance.select();
    return this.success('666');
  }
  /**
   * put resource
   * @return {Promise} []
  ...
  __call() {
    //判断是否是get请求
    // let isGet=this.ctx.isGet();
    // console.log(isGet,'判断是否是get请求')
    console.log(this.ctx,'akjskjsakjsasakj');
